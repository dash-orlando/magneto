...
LMstat lmstat;
levmarq solver( &lmstat );
void setup() {
  Serial.begin( 115200 );
  int n_iterations;
   Serial.print( "STARTING\n" );
  n_iterations = solver.levmarq_solve(N_PARAMS, params, N_MEASUREMENTS, t_data, NULL,
                         &newton_func, &gradient, NULL, &lmstat);
  Serial.print( "**************** End of calculation ***********************\n" );
  Serial.print( "N iterations: " );
  ...
  Serial.print("**************** Interpolation test ***********************\n");
  Serial.print("Search for temp 70 degrees\n");
  Serial.print("Result: ");
  Serial.print( temp_to_time(params, 50.0) );
