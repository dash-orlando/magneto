...
def LHS( root, K, norms ):
    ...
    r1 = float( ( (x+0.000)**2. + (y+0.000)**2. + (z-0.100)**2. )**(1/2.) )  # Sensor 1 (Origin)
    ...
    r5 = float( ( (x+0.000)**2. + (y+0.000)**2. + (z+0.000)**2. )**(1/2.) )  # Sensor 5 
    r6 = float( ( (x+0.062)**2. + (y+0.000)**2. + (z+0.000)**2. )**(1/2.) )  # Sensor 6 
